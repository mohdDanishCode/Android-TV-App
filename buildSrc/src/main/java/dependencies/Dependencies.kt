...
object Dependencies {
    ...
    const val LIFECYCLE_VIEWMODEL = "androidx.lifecycle:lifecycle-viewmodel-ktx:${BuildDependenciesVersions.LIFECYCLE_VIEW_MODEL}"
    const val LIFECYCLE_RUNTIME = "androidx.lifecycle:lifecycle-runtime-ktx:${BuildDependenciesVersions.LIFECYCLE_RUNTIME}"
    ...
    const val CCP = "com.hbb20:ccp:${BuildDependenciesVersions.CCP}"
    const val EASY_PERMISSION = "pub.devrel:easypermissions:${BuildDependenciesVersions.EASY_PERMISSION}"
}
